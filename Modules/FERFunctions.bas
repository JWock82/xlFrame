...
Public Function FER_LinLoad(w1 As Double, w2 As Double, x1 As Double, x2 As Double, L As Double) As Matrix
    ...
    Call FER_LinLoad.SetValue(2, 1, (x1 - x2) * (-3 * L * (w1 + w2) + w1 * (2 * x1 + x2) + w2 * (x1 + 2 * x2)) / (6 * L))
    Call FER_LinLoad.SetValue(3, 1, -(x1 - x2) * (12 * w1 * x1 ^ 3 + 3 * w1 * x2 ^ 3 + 3 * w2 * x1 ^ 3 + 12 * w2 * x2 ^ 3 - 30 * L * w1 * x1 ^ 2 + _
    ...
    Call FER_LinLoad.SetValue(5, 1, -(x1 - x2) * (w1 * (2 * x1 + x2) + w2 * (x1 + 2 * x2)) / (6 * L))
    Call FER_LinLoad.SetValue(6, 1, -(x1 - x2) * (12 * w1 * x1 ^ 3 + 3 * w1 * x2 ^ 3 + 3 * w2 * x1 ^ 3 + 12 * w2 * x2 ^ 3 - 15 * L * w1 * x1 ^ 2 - _
